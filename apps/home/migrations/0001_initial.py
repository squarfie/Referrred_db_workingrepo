# Generated by Django 5.2.1 on 2025-06-20 00:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Lab_Staff_Details',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('LabStaff_Name', models.CharField(blank=True, max_length=100, null=True)),
                ('LabStaff_Designation', models.CharField(blank=True, max_length=100, null=True)),
                ('LabStaff_Telnum', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region='PH')),
                ('LabStaff_EmailAdd', models.EmailField(blank=True, max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Recommendation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccessionNo', models.CharField(blank=True, max_length=255)),
                ...
                ('Nosocomial', models.CharField(choices=[('n/a', ''), ('Yes', 'Yes'), ('No', 'No')], default='', max_length=255)),
                ...
                ('Service_Type', models.CharField(choices=[('n/a', ''), ('In', 'In'), ('Out', 'Out')], default='', max_length=255)),
                ...
                ('Reason', models.TextField(choices=[('n/a', ''), ('a & d', 'a & d'), ('confirmation of org and ast', 'a'), ('for ast only', 'b'), ('difficult to ID', 'c'), ('for serotyping', 'd'), ('for research', 'e'), ('Others', 'o')], default='', max_length=255)),
                ('Growth', models.CharField(blank=True, max_length=255)),
                ('Urine_ColCt', models.CharField(blank=True, max_length=255)),
                ('ampC', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ESBL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('CARB', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('MBL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('BL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('MR', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('mecA', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ICR', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ...
                ('ars_ampC', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_ESBL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_CARB', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_ECIM', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_MCIM', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_EC_MCIM', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_MBL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_BL', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_MR', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_mecA', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ('ars_ICR', models.CharField(choices=[('n/a', ''), ('(+)', '(+)'), ('(-)', '(-)'), ('NT', 'NT')], default='', max_length=255)),
                ...
                ('Encoded_by', models.CharField(blank=True, max_length=255)),
                ('Encoded_by_Initials', models.CharField(blank=True, max_length=255)),
                ('Edited_by', models.CharField(blank=True, max_length=255)),
                ('Edited_by_Initials', models.CharField(blank=True, max_length=255)),
                ('Checked_by', models.CharField(blank=True, max_length=255)),
                ('Checked_by_Initials', models.CharField(blank=True, max_length=255)),
                ('Verified_by_Senior', models.CharField(blank=True, max_length=255)),
                ('Verified_by_Senior_Initials', models.CharField(blank=True, max_length=255)),
                ('Verified_by_LabManager', models.CharField(blank=True, max_length=255)),
                ('Verified_by_LabManager_Initials', models.CharField(blank=True, max_length=255)),
                ('Noted_by', models.CharField(blank=True, max_length=255)),
                ('Noted_by_Initials', models.CharField(blank=True, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ab_idNum_referred', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='antibiotic_entries', to='home.referred_data')),
            ],
            options={

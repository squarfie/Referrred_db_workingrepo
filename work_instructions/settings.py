...
LOGIN_URL = '/Referred_db/login/'
LOGIN_REDIRECT_URL = '/Referred_db/'
LOGOUT_REDIRECT_URL = '/Referred_db/login/'
...
# STATICFILES_DIRS must be a LIST of paths
STATICFILES_DIRS = [
